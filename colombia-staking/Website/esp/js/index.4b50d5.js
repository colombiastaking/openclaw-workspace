...
var e=document.querySelector('.un11');e.setAttribute('src',(dpi>1)?'images/grayscale-transparent-1990.png':'images/grayscale-transparent-995.png');}else if($(window).width()>=960){var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?'images/transparent-logo-260.png':'images/transparent-logo-130.png');
...
var e=document.querySelector('.un11');e.setAttribute('src',(dpi>1)?'images/grayscale-transparent-1594.png':'images/grayscale-transparent-797.png');}else if($(window).width()>=768){var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?'images/transparent-logo-208-1.png':'images/transparent-logo-104.png');
...
var e=document.querySelector('.un11');e.setAttribute('src',(dpi>1)?'images/grayscale-transparent-1274.png':'images/grayscale-transparent-637.png');}else if($(window).width()>=480){var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?'images/transparent-logo-198.png':'images/transparent-logo-99.png');
...
var e=document.querySelector('.un11');e.setAttribute('src',(dpi>1)?'images/grayscale-transparent-950.png':'images/grayscale-transparent-475.png');}else{var e=document.querySelector('.un1');e.setAttribute('src',(dpi>1)?'images/transparent-logo-132.png':'images/transparent-logo-66.png');
...
var e=document.querySelector('.un11');e.setAttribute('src',(dpi>1)?'images/grayscale-transparent-634.png':'images/grayscale-transparent-317.png');}}};
...
window.loadyt(function(){var p=new YT.Player('pl1',{host:'https://www.youtube-nocookie.com',videoId: 'pBTvnsSsJqs',playerVars:{'playsinline':1,'rel':0},events:{onStateChange:function(e){1===e.data&&plst('pl1',function(){e.target.pauseVideo()}),2===e.data&&plrm('pl1')}}});});initMenu($('#m1')[0]);
initMenu($('#m2')[0]);
$('.s6').Stickyfill();
wl=new woolite();
wl.init();
