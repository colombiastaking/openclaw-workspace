 ...
 */
import fs from 'fs';
import pkg from '@multiversx/sdk-network-providers';
const { ProxyNetworkProvider } = pkg;
import pkg2 from '@multiversx/sdk-core';
const { Address, Transaction, TransactionPayload } = pkg2;
import pkg3 from '@multiversx/sdk-wallet';
const { UserSecretKey } = pkg3;
...
// Missing amounts (from bonus_distribution files)
const missing = [
  { date: 'March 27', amount: 0.0006843746295037028, nonce: 5648 },
  { date: 'March 28', amount: 0.0006861176746461974, nonce: 5649 },
];

const tokenIdHex = '434f4c532d396439316237'; // COLS-9d91b7
